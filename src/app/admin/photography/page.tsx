  ...
  return (
    <div className={styles.shell}>
      <main className="admin-page">
        ...
        <header className="admin-page-header"><div><p className="section-label">Admin / Photography</p><h1>Photography collections</h1><p>Build and publish the collections shown on the public Photography archive.</p></div><div className="admin-header-actions"><Link href="/photography" className="admin-button">View public archive</Link><Link href="/admin/media/upload" className="admin-button">Upload photographs</Link></div></header>
