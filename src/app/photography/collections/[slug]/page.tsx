...
export default async function PhotographyCollectionPage({ params }: Props) {
  ...
  return (
    <main className="photography-page photography-collection-page">
      ...
      <style>{`.photography-collection-page{position:relative;isolation:isolate}.photography-collection-header{max-width:52rem;padding-block:clamp(2.5rem,7vw,6rem) clamp(2.5rem,5vw,4rem)}.photography-back-link{display:inline-block;margin-bottom:2rem;color:inherit;text-decoration:none}.photography-collection-header h1{max-width:12ch;margin:.75rem 0 1rem;font-family:var(--font-cormorant),Georgia,serif;font-size:clamp(1.6rem,3vw,2.3rem)}.photography-collection-header>p:not(.section-label){max-width:38rem;margin:0 0 1rem;font-size:1.15rem}.photography-collection-header>span{font-family:var(--font-plex-mono),monospace;font-size:.75rem;letter-spacing:.1em;text-transform:uppercase;opacity:.62}@media(max-width:760px){.photography-collection-header{padding-block:2.5rem 3rem}}`}</style>
    </main>
  );
}
